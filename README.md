...
| ------------ | --------------------- | ------------------ | ------------------------------------------------------------------------------ | ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Python       | ✅                    | ✅                 | ✅ `basedpyright` prototype + semantic-token payloads                          | ❌                                          | semantic-token inspection works for the shipped sample, but the normal tool row still falls back to basic highlighting |
